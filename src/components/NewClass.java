 ...
 * @author ASUS
 */
//import filebrowser.FileTableModel;
//import filebrowser.FileTreeCellRenderer;
//import static filebrowser.FileBrowser.APP_TITLE;
 ...
 public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                NewClass FileBrowser = new NewClass();
